...
CREATE TABLE IF NOT EXISTS linkedin_ads_raw (
  ...
  avg_frequency DECIMAL(6,3) DEFAULT 0,
  lead_form_completion_rate DECIMAL(6,4) DEFAULT 0,
  conversions INTEGER DEFAULT 0,
  cost_per_conversion DECIMAL(10,2) DEFAULT 0,
  engagement_rate DECIMAL(8,5) DEFAULT 0,
  ...
  cost_per_open DECIMAL(10,2) DEFAULT 0,
